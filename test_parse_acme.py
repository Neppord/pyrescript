...
skip = {
    ...
    os.path.join("e2e", "acme", ".spago", "css-frameworks", "v1.0.1", "src", "CSSFrameworks", "BootstrapIcons.purs"),
    os.path.join("e2e", "acme", ".spago", "css-frameworks", "v1.0.1", "src", "CSSFrameworks", "BoxIcons.purs"),
